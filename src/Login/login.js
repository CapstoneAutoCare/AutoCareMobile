...
export default Login = ({ navigation }) => {
    return (
        <SafeAreaView style={{ width: '100%', height: '100%' }}>
            <Text style={{ fontSize: 30, marginTop: '70%', textAlign: 'center', color: 'red' }}>AUTO CARE</Text>
            ...
            <View style={{ width: '100%' }}>
                ...
                <TouchableOpacity>
                    <Text style={{ fontSize: 15, color: 'red', textAlign: 'center', marginBottom: 10 }}>Quên mật khẩu ?</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => navigation.navigate('Register')}>
                    <Text style={{ fontSize: 15, color: 'red', textAlign: 'center' }}>Đăng ký</Text>
                </TouchableOpacity>
            </View>
